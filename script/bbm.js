...
module.exports.config = {
  ...
  role: 0,
  credits: "Kaizenji",
  description: "Generate a BBM meme using two texts.",
  cooldown: 5,
  hasPrefix: true,
  usage: "bbm text1 | text2",
};
...
module.exports.run = async function ({ api, event, args }) {
  ...
  if (args.length === 0 || !args.join(" ").includes("|")) {
    return api.sendMessage(applyFontMapping("Usage: bbm text1 | text2"), tid, (err, info) => {
  ...
  const outputPath = __dirname + `/cache/bbm_${tid}_${mid}.png`;
