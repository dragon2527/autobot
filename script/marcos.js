...
module.exports.config = {
  ...
  role: 0,
  credits: "Kaizenji",
  description: "Generate a Marcos meme using a text.",
  cooldown: 5,
  hasPrefix: true,
  usage: "marcos <text>",
};
...
module.exports.run = async function ({ api, event, args }) {
  ...
  const outputPath = __dirname + `/cache/marcos_${tid}_${mid}.png`;

  try {
    const apiUrl = `https://api-canvass.vercel.app/marcos?text=${encodeURIComponent(text)}`;
